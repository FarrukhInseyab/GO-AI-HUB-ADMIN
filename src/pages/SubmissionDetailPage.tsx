...
import { Calendar, MessageSquare, Mail, Building2, Brain, Zap, Globe, Users, FileText, Paperclip, MapPin, DollarSign, TrendingUp, Shield, Wrench, CheckCircle, XCircle, AlertTriangle, RotateCcw, ArrowLeft } from 'lucide-react';
...
const SubmissionDetailPage: React.FC = () => {
  ...
  const getBreadcrumbItems = () => {
    return [
      { label: t('solutions.title'), href: '/submissions' },
