...
const BusinessSolutionPage: React.FC = () => {
  ...
  const getBreadcrumbItems = () => {
    const items = [
      { label: t('businessInterest.title'), href: '/business-interest' }
    ];

    if (solution) {
      items.push({ label: solution.solution_name });
    }
      ...
      <div className="min-h-screen bg-app-gradient">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center py-12 bg-gradient-to-br from-gray-50 to-teal-50 rounded-xl shadow-lg">
            ...
            >
              {t('common.back')} {t('businessInterest.title')}
            </Button>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-app-gradient">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 animate-fade-in-up">
          ...
          <h1 className="text-3xl font-bold text-gradient-primary mt-4">{t('solutions.solutionDetails')}</h1>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            <Card className="shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <CardHeader className="bg-gradient-to-r from-teal-50 to-cyan-50 border-b">
                <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-xl font-bold text-gradient-primary">{formatValue(solution.solution_name)}</h2>
                    <p className="text-gray-600 mt-1">{formatValue(solution.summary)}</p>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-center">
                      <Building2 className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                        <span className="text-sm font-medium text-gray-500">Company Name:</span>
                        <span 
                          className="text-teal-600 hover:text-teal-800 cursor-pointer block transition-colors duration-200"
                          onClick={() => navigate(`/companies/${solution.company_name}`)}
                        >
                          {formatValue(solution.company_name)}
                        </span>
                      </div>
                    </div>
                    
                    <div className="flex items-center">
                      <MapPin className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                        <span className="text-sm font-medium text-gray-500">Country:</span>
                        <p className="text-gray-700">{formatValue(solution.country)}</p>
                      </div>
                    </div>

                    {solution.website && (
                      <div className="flex items-center">
                        <Globe className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                        <div>
                          <span className="text-sm font-medium text-gray-500">Website:</span>
                          <a href={solution.website} target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-800 block transition-colors duration-200">
                    ...
                    <div className="flex items-center">
                      <DollarSign className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                        <span className="text-sm font-medium text-gray-500">Revenue:</span>
                        <p className="text-gray-700">{formatValue(solution.revenue)}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      <Users className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                        <span className="text-sm font-medium text-gray-500">Employees:</span>
                        <p className="text-gray-700"><span className="arabic-numerals">{formatValue(solution.employees)}</span></p>
                      </div>
                    </div>

                    <div className="flex items-center">
                      <FileText className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                        <span className="text-sm font-medium text-gray-500">Registration Document:</span>
                        {solution.registration_doc ? (
                          <a href={solution.registration_doc} target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-800 block transition-colors duration-200">
                            View Document
                          </a>
                        ) : (
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        {solution.linkedin ? (
                          <a href={solution.linkedin} target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-800 block transition-colors duration-200">
                            View Profile
                          </a>
                        ) : (
                          <p className="text-gray-700">N/A</p>
            ...
            <Card className="shadow-xl hover:shadow-2xl transition-shadow duration-300 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">{formatValue(solution.contact_name)}</p>
                      </div>
                    </div>

                    <div className="flex items-center">
                      <Wrench className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                        <span className="text-sm font-medium text-gray-500">Position:</span>
                        <p className="text-gray-700">{formatValue(solution.position)}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      <Mail className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                        <span className="text-sm font-medium text-gray-500">Contact Email:</span>
                        <a href={`mailto:${solution.contact_email}`} className="text-teal-600 hover:text-teal-800 block transition-colors duration-200">
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {industryFocusList.length > 0 ? (
                          industryFocusList.map((industry, index) => (
                            <span
                              key={index}
                              className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-800 shadow-sm"
                            >
                              {industry}
                            </span>
                          ))
                      ...
                      <div className="flex flex-wrap gap-2">
                        {techCategoriesList.length > 0 ? (
                          techCategoriesList.map((tech, index) => (
                            <span
                              key={index}
                              className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-gradient-to-r from-purple-100 to-violet-100 text-purple-800 shadow-sm"
                            >
                              {tech}
                            </span>
                          ))
                      ...
                      <div className="flex flex-wrap gap-2">
                        {autoTagsList.length > 0 ? (
                          autoTagsList.map((tag, index) => (
                            <span
                              key={index}
                              className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-gradient-to-r from-gray-100 to-slate-100 text-gray-800 shadow-sm"
                            >
                              {tag}
                            </span>
                          ))
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex items-center">
                      <Shield className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                    ...
                    <div className="flex items-center">
                      <TrendingUp className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-center">
                      <CheckCircle className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                      <div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">{formatValue(solution.ksa_customization_details)}</p>
                    </div>
                  </div>
                      ...
                      <div className="bg-gradient-to-r from-gray-50 to-teal-50 p-4 rounded-lg shadow-inner">
                        <div className="flex flex-wrap gap-2">
                          {clientsList.map((client, index) => (
                            <span
                              key={index}
                              className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-gradient-to-r from-emerald-100 to-green-100 text-emerald-800 shadow-sm"
                            >
                              {client}
                            </span>
                          ))}
            ...
            {(solution.pitch_deck || solution.demo_video || (solution.product_images && Array.isArray(solution.product_images) && solution.product_images.length > 0)) && (
              <Card className="shadow-xl hover:shadow-2xl transition-shadow duration-300 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    {solution.pitch_deck && (
                      <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-teal-50 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                        <div className="flex items-center">
                          <div className="p-2 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-lg mr-3 rtl:mr-0 rtl:ml-3 shadow-md">
                            <FileText className="h-5 w-5 text-white" />
                          </div>
                          <span className="text-gray-700 font-medium">Pitch Deck</span>
                        </div>
                        <a
                          href={solution.pitch_deck}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-teal-600 hover:text-teal-800 flex items-center transition-colors duration-200"
                        >
                    ...
                    {solution.demo_video && (
                      <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-teal-50 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-700 font-medium">Demo Video</span>
                        </div>
                        <a
            ...
            <Card className="shadow-xl hover:shadow-2xl transition-shadow duration-300 animate-fade-in-up" style={{ animationDelay: '0.35s' }}>
              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="flex items-center">
                    <Calendar className="h-4 w-4 text-teal-500 mr-2 rtl:mr-0 rtl:ml-2" />
                    <div>
            ...
            <Card className="shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <CardHeader className="bg-gradient-to-r from-teal-50 to-cyan-50">
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-3 py-1.5 text-sm font-medium bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-800 rounded-full shadow-sm">
                    ...
                    interests.map((interest, index) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <div 
                            className="text-teal-600 hover:text-teal-800 cursor-pointer font-medium transition-colors duration-200"
                            onClick={() => navigate(`/companies/${interest.company_name}`)}
                          >
                            <div className="flex items-center">
                              <Building2 className="h-4 w-4 mr-2 rtl:mr-0 rtl:ml-2" />
                        ...
                        <div className="flex items-center text-sm text-gray-500 mb-2">
                          <Calendar className="h-4 w-4 mr-1 rtl:mr-0 rtl:ml-1 text-teal-500" />
                          {new Date(interest.created_at).toLocaleDateString()}
                        </div>

                        <div className="flex items-center text-sm text-gray-500 mb-2">
                          <Mail className="h-4 w-4 mr-1 rtl:mr-0 rtl:ml-1 text-teal-500" />
                          <a 
                        ...
                        {interest.status === 'Lead Initiated' && interest.comments && (
                          <div className="mb-4 p-3 bg-gradient-to-r from-gray-50 to-teal-50 rounded-lg border border-teal-100">
                            <p className="text-sm text-gray-600">{interest.comments}</p>
